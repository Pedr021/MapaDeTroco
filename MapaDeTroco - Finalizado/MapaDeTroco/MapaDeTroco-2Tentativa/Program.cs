    ...
    class Program
    {
        static void Main()
        {
            ...
            while (true)
            {
                ...
                try
                {
                    decimal.TryParse(Console.ReadLine(), NumberStyles.Float, CultureInfo.InvariantCulture, out input);
        ...
        static void MostrarTroco(List<TrocoMoeda> troco)
        {
